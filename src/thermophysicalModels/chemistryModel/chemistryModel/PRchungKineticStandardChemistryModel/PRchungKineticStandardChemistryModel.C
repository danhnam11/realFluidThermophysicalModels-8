...
Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::PRchungKineticStandardChemistryModel
(
...
:
    ...
    specieThermos_
    (
        dynamic_cast<const PRchungKineticMixture<ThermoType>&>
    ...
    dcdt_(nSpecie_)
{
    ...
    Info<< "PRchungKineticStandardChemistryModel: Number of species = " << nSpecie_
...
template<class ReactionThermo, class ThermoType>
Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::
...
template<class ReactionThermo, class ThermoType>
void Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::omega
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::omegaI
(
    const label index,
    const scalar p,
    const scalar T,
...
template<class ReactionThermo, class ThermoType>
void Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    const label li,
...
template<class ReactionThermo, class ThermoType>
void Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    const label li,
...
Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::tc() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::Qdot() const
{
...
Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::calculateRR
(
    const label ri,
    const label si
) const
...
template<class ReactionThermo, class ThermoType>
void Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::calculate()
{
    if (!this->chemistry_)
    {
        return;
...
Foam::scalar Foam::PRchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::solve
(
