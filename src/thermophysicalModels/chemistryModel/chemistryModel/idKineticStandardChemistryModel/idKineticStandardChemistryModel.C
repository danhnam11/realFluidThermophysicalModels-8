...
Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::idKineticStandardChemistryModel
(
...
:
    ...
    specieThermos_
    (
        dynamic_cast<const idKineticMixture<ThermoType>&>
    ...
    dcdt_(nSpecie_)
{
    ...
    Info<< "idKineticStandardChemistryModel: Number of species = " << nSpecie_
...
template<class ReactionThermo, class ThermoType>
Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::
...
template<class ReactionThermo, class ThermoType>
void Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::omega
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::omegaI
(
    const label index,
    const scalar p,
    const scalar T,
...
template<class ReactionThermo, class ThermoType>
void Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    const label li,
...
template<class ReactionThermo, class ThermoType>
void Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    const label li,
...
Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::tc() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::Qdot() const
{
...
Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::calculateRR
(
    const label ri,
    const label si
) const
...
template<class ReactionThermo, class ThermoType>
void Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::calculate()
{
    if (!this->chemistry_)
    {
        return;
...
Foam::scalar Foam::idKineticStandardChemistryModel<ReactionThermo, ThermoType>::solve
(
