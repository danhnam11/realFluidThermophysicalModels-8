...
Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::SRKchungKineticStandardChemistryModel
(
...
:
    ...
    specieThermos_
    (
        dynamic_cast<const SRKchungKineticMixture<ThermoType>&>
    ...
    dcdt_(nSpecie_)
{
    ...
    Info<< "SRKchungKineticStandardChemistryModel: Number of species = " << nSpecie_
...
template<class ReactionThermo, class ThermoType>
Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::
...
template<class ReactionThermo, class ThermoType>
void Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::omega
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::omegaI
(
    const label index,
    const scalar p,
    const scalar T,
...
template<class ReactionThermo, class ThermoType>
void Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    const label li,
...
template<class ReactionThermo, class ThermoType>
void Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    const label li,
...
Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::tc() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::Qdot() const
{
...
Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::calculateRR
(
    const label ri,
    const label si
) const
...
template<class ReactionThermo, class ThermoType>
void Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::calculate()
{
    if (!this->chemistry_)
    {
        return;
...
Foam::scalar Foam::SRKchungKineticStandardChemistryModel<ReactionThermo, ThermoType>::solve
(
