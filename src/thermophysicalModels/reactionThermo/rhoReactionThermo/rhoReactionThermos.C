...
namespace Foam
{
    //forKineticGases(makeRhoReactionThermos, kineticMultiComponentMixture); //

    forSRKchungTakaGases(makeRhoReactionThermos, SRKchungTakaMixture); //
    forPRchungTakaGases(makeRhoReactionThermos, PRchungTakaMixture); //

    forSRKchungKineticGases(makeRhoReactionThermos, SRKchungKineticMixture); //
    forPRchungKineticGases(makeRhoReactionThermos, PRchungKineticMixture); //

    forIdKineticGases(makeRhoReactionThermos, idKineticMixture); //
