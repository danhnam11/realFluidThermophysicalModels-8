...
Foam::idKineticMixture<ThermoType>::readSpeciesData
(
...
template<class ThermoType>
typename Foam::idKineticMixture<ThermoType>::speciesCompositionTable
Foam::idKineticMixture<ThermoType>::readSpeciesComposition
(
    const dictionary& thermoDict,
