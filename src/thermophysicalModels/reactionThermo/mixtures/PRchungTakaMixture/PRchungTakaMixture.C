...
Foam::PRchungTakaMixture<ThermoType>::readSpeciesData
(
...
template<class ThermoType>
typename Foam::PRchungTakaMixture<ThermoType>::speciesCompositionTable
Foam::PRchungTakaMixture<ThermoType>::readSpeciesComposition
(
    const dictionary& thermoDict,
