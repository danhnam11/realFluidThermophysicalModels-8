...
Foam::SRKchungKineticMixture<ThermoType>::readSpeciesData
(
...
template<class ThermoType>
typename Foam::SRKchungKineticMixture<ThermoType>::speciesCompositionTable
Foam::SRKchungKineticMixture<ThermoType>::readSpeciesComposition
(
    const dictionary& thermoDict,
    ...
    //- end
{
    ...
    // End of calculation for Kinetic
