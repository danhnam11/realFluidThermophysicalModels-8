...
namespace Foam
{
    ...
    //forKineticGases(makePsiReactionThermos, kineticMultiComponentMixture); //

    forSRKchungTakaGases(makePsiReactionThermos, SRKchungTakaMixture); //
    forPRchungTakaGases(makePsiReactionThermos, PRchungTakaMixture); //

    forSRKchungKineticGases(makePsiReactionThermos, SRKchungKineticMixture); //
    forPRchungKineticGases(makePsiReactionThermos, PRchungKineticMixture); //

    forIdKineticGases(makePsiReactionThermos, idKineticMixture); //
}
