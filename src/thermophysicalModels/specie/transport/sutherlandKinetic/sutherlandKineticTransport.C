...
:
    ...
    */
    epsilonOverKb_(dict.subDict("dataForKineticTrans").lookup<scalar>("epsilonOverKb")),
    sigma_(dict.subDict("dataForKineticTrans").lookup<scalar>("sigma")),
    miui_(dict.subDict("dataForKineticTrans").lookup<scalar>("miui")),
    polar_(dict.subDict("dataForKineticTrans").lookup<scalar>("alpha")),
