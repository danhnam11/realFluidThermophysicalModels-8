...
void Foam::rfJanafThermo<EquationOfState>::checkInputData() const
{
    if (Tlow_ >= Thigh_)
    {
...
template<class EquationOfState>
Foam::rfJanafThermo<EquationOfState>::rfJanafThermo(const dictionary& dict)
:
...
template<class EquationOfState>
void Foam::rfJanafThermo<EquationOfState>::write(Ostream& os) const
{
